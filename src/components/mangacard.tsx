...
export default function MangaCard({ Title, Desc, image, link }: CusProps) {
    return (
        <Link href={link}>
            <div className="relative group cursor-pointer overflow-hidden text-gray-50 h-72 w-max rounded hover:duration-500 duration-500 m-[1rem]">
                ...
                <div className="absolute bg-gray-50 group-hover:bg-[#cccccca2] group-hover:backdrop-blur-md -bottom-24 w-56 p-3 flex flex-col gap-1 group-hover:-bottom-0 group-hover:duration-500 duration-500">
