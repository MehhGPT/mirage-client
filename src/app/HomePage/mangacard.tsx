export default function MangaCard() {
  return (
    <div className="relative group duration-500 cursor-pointer overflow-hidden text-gray-50 h-72 w-65 rounded hover:duration-700 duration-700 pl-5">
      ...
      <div className="absolute bg-gray-50 -bottom-24 w-56 p-3 flex flex-col gap-1 group-hover:-bottom-0 group-hover:duration-600 duration-500">
        ...
        <span className="text-gray-800 font-bold text-3xl">Berserk</span>
